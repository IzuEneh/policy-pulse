...
const summaries = [
  ...
  },
  {
    ...
    summary:
      `The "Preventing Sex Trafficking and Strengthening Families Act" aims to prevent and address sex trafficking of children in foster care,
    ...
    timeline:
      "Introduced September 29, 2014 and is now law",
    status:
      "Became law",
    controversy:
    ...
    <main className="flex min-h-screen flex-col p-5 gap-5">
      ...
      <div className="flex flex-1 flex-col gap-5">
        ...
        <div className="flex flex-1 flex-col">
          <h2 className="text-2xl capitalize">status</h2>
        ...
        <div className="flex flex-1 flex-col">
          <h2 className="text-2xl capitalize">timeline</h2>
          <p>{fullSummary.timeline}</p>
        </div>
        <div className="flex flex-1 flex-col">
          <h2 className="text-2xl capitalize">controversy</h2>
          <p>{fullSummary.controversy}</p>
        </div>
        <div className="flex flex-1 flex-col">
          <h2 className="text-2xl capitalize">comparison</h2>
